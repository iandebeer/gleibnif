...
enum  DIDCommMessageProtocolTypes(val typ: String) :
  case Forward extends DIDCommMessageProtocolTypes("https://didcomm.org/routing/2.0/forward")

object DIDCommMessageProtocolTypes:
  def parse(typ: String): DIDCommMessageProtocolTypes = 
    typ match
      case "https://didcomm.org/routing/2.0/forward" => DIDCommMessageProtocolTypes.Forward
      case _                                         => throw DIDDocException("Unknown type")

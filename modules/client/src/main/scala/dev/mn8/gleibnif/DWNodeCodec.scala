...
object DWNodeCodec :
  ...
  given encodeDWNodeMessage: Encoder[DWNodeMessage] = new Encoder[DWNodeMessage]:
    final def apply(a: DWNodeMessage): Json = 
      Json.obj(
        ("messages", Json.fromValues(a.messages.map(encodeDWNodeRequestMessage.apply)))
      )

  given encodeDWNodeRequestMessage: Encoder[DWNodeRequestMessage] = new Encoder[DWNodeRequestMessage]:
    final def apply(a: DWNodeRequestMessage): Json = 
      Json.obj(
        ...
        ("attestations", Json.fromValues(a.attestations.getOrElse(List.empty[DWNodeAttestation]).map(encodeAttestation.apply))),
        ("authorizations", Json.fromValues(a.authorizations.getOrElse(List.empty[DWNodeAuthorization]).map(encodeAuthorization.apply)))
      )
      

  given encodeAttestation: Encoder[DWNodeAttestation] = new Encoder[DWNodeAttestation]:
    final def apply(a: DWNodeAttestation): Json = 
      Json.obj(
        ("payload", Json.fromString(a.payload)),
        ("signatures", Json.fromValues(a.signatures.map(encodeSignature.apply)))
      ) 

  given encodeAuthorization: Encoder[DWNodeAuthorization] = new Encoder[DWNodeAuthorization]:
  ...
  given encodeSignature: Encoder[DWNodeSignature] = new Encoder[DWNodeSignature]:
  ...
  given decodeDWNodeMessage: Decoder[DWNodeMessage] = new Decoder[DWNodeMessage]:
    final def apply(c: HCursor): Result[DWNodeMessage] = 
      for
        messages <- c.downField("messages").as[List[DWNodeRequestMessage]]
      yield DWNodeMessage(messages)

  given decodeDWNodeRequestMessage: Decoder[DWNodeRequestMessage] = new Decoder[DWNodeRequestMessage]:
    final def apply(cur: HCursor): Result[DWNodeRequestMessage] = 
      ...
      for {
        ...
        attestations <- c.downField("attestations").as[Option[List[DWNodeAttestation]]]
        authorizations <- c.downField("authorizations").as[Option[List[DWNodeAuthorization]]]
      }
      yield DWNodeRequestMessage(recordId, data, processing, descriptor, attestations, authorizations)

  given decodeDWNodeDescriptor: Decoder[DWNodeDescriptor] = new Decoder[DWNodeDescriptor]:
  ...
  given decodeDWNodeProcessing: Decoder[DWNodeProcessing] = new Decoder[DWNodeProcessing]:
  ...
  given decodeDWNodeAttestation: Decoder[DWNodeAttestation] = new Decoder[DWNodeAttestation]:
  ...
  given decodeDWNodeAuthorization: Decoder[DWNodeAuthorization] = new Decoder[DWNodeAuthorization]:
  ...
  given decodeDWNodeSignature: Decoder[DWNodeSignature] = new Decoder[DWNodeSignature]:

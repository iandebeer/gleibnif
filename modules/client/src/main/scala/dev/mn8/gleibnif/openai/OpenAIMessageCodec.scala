...
object OpenAIMessageCodec {
  ...
  given openAIChoiceDecoder: Decoder[OpenAIResponseChoice] = new Decoder[OpenAIResponseChoice] {
    def apply(c: HCursor): Result[OpenAIResponseChoice] =
      for
        text <- c.downField("text").as[String]
        index <- c.downField("index").as[Int]
        logprobs <- c.downField("logprobs").as[Option[OpenAIResponseChoiceLogProbs]]
  ...
  given openAILogProbsDecoder: Decoder[OpenAIResponseChoiceLogProbs] = new Decoder[OpenAIResponseChoiceLogProbs] {
    def apply(c: HCursor): Result[OpenAIResponseChoiceLogProbs] =
      for
        tokenLogProbs <- c.downField("token_logprobs").as[Option[Map[String, List[Double]]]]
        textLogProbs <- c.downField("text_logprobs").as[Option[Map[String, List[Double]]]]
        textOffset <- c.downField("text_offset").as[Option[Map[String, List[Double]]]]  
      yield OpenAIResponseChoiceLogProbs(tokenLogProbs, textLogProbs, textOffset)
  }

  given openAIUsageDecoder: Decoder[OpenAIResponseUsage] = new Decoder[OpenAIResponseUsage] {
  ...
  given openAIRequestEncoder: Encoder[OpenAIRequest] = new Encoder[OpenAIRequest] {
